...
/**
 * Created by ronnykibet on 22/01/18.
 * Extended by tomsturgeon on 17/04/2018.
 *
 * SimpleMail sends an email from seatonautoemail@gmail.com to the email specified in ComplaintFragment
 */
public class SimpleMail {

    /**CHANGE ACCORDINGLY**/
    private static final String SMTP_HOST_NAME = "smtp.gmail.com"; //can be your host server smtp@yourdomain.com
    private static final String SMTP_AUTH_USER = ""; //your login username/email
    ...
    public static void sendEmail(String to, String subject, String msg){
        ...
        String from = "seatonautomailer@gmail.com"; //from
